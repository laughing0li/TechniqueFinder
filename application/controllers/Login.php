...
class Login extends CI_Controller
{
    ...
    public function setupAuth0(): void
    {
        $this->auth0 = new Auth0([
            ...
            // 'redirect_uri' => 'https://dt-test-326006.ts.r.appspot.com/callback',
    ...
    public function onLogoutRoute()
    {
        ...
        $this->auth0->logout();
        $this->auth0->deleteAllPersistentData();
        // redirect('https://dev-68ut2myz.us.auth0.com/v2/logout?client_id=ubyDQgyXX9U4vQSETnCmgzQHB8PLQWEf&returnTo=https://dt-test-326006.ts.r.appspot.com/Portal');
