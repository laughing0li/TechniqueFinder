...
<body>
    ...
    <div id="main">
        <div id="content">
            ...
            <?php echo $staticData['tf.physicsChoices.quickGuide']; ?>
    ...
    <div style="float:left;">
        <table style="text-align: left;">
            <tr>
                ...
                <div class="tf-setp-title"><?php echo strip_tags($staticData['tf.physicsChoices.left.title']);?> </div>
                    <ul style="padding-left:15px;">
                        <?php
/**
 * TechniqueFinder - phys_options_selection.php
 *
 * Description:
...
foreach($left_list as $r){
                ...
                <td style="width:100px; vertical-align:center;" >
                    ...
                    <span style="text-align:center;"><h1 class="tf-heading"><?php echo strip_tags($staticData['tf.physicsChoices.comparison.title']);?> </h1></span>
                </td>
                <td class="tf-yellow-box" valign="top">
                    <div class="tf-setp-title"><?php echo strip_tags($staticData['tf.physicsChoices.right.title']);?> </div>
                    <ul style="padding-left:15px;">
                        <?php
