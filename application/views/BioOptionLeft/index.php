...
<div class="nav tf-navbar">
    ...
    <button class="btn" onclick="window.location='<?php echo base_url();?>BioOptionLeft/create_new'">
...
<div class="row" style="margin-left: 1em; ">
    <h1 class="tf-heading"> Left side option list for Biological sciences </h1>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#the_datatable').DataTable({
            ...
            bInfo : false,
            ajax: {
                url : "<?php echo site_url("BioOptionLeft/getList") ?>",
            ...
            initComplete: function( settings, json ) {
                ...
                $('#the_datatable > tbody').sortable({
                    update:function(){
                        ...
                        $.ajax({
                            url: "<?php echo site_url('BioOptionLeft/updatePriorities');?>",
                            type:'POST',
