...
<head><title>TF Admin | Edit Reference</title></head>
...
<div class="row" style="margin-left: 1em; ">
    <h1 class="tf-heading"> Edit Reference</h1>
</div>
...
<?php echo form_open('References/validateEdit/'.$data['id']);?>
    ...
    <table style="text-align: left;display: block; clear: both;" >
        <tr style="width:50em;">
            ...
            <td class="tf-font tf-font-size">
                <textarea name="referenceNames"  rows="6" cols="112"><?php if(isset($data['reference_names'])){echo $data['reference_names'];} ?></textarea>
            </td>
            </td>
        ...
        <tr style="width:50em;">
            ...
            <td class="tf-font tf-font-size">
                ...
                <textarea name="fullReference" class="ckeditor" id="ckeditor">
                        <html><?php if(isset($data['full_reference'])){echo $data['full_reference'];} ?></html>
                </textarea>
            </td>
            </td>
        </tr>
...
<button id="update" class="tf-button" type="button" onclick="deleteReferences()">
...
<script>
    ...
    function deleteReferences(){
        if (confirm("Are you sure?")){
            window.location.assign('<?php echo site_url("References/delete/").$data['id']?>')
        }
