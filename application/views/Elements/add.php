...
<head>
    <title>TF Admin | Create Elements</title>
</head>
<div class="bg-color">
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-10" style="margin-left: 50px;">
                    <div class="row">
                        <h1 class="tf-heading"> Create Elements</h1>
                    </div>
                    ...
                    <?php echo form_open("elements/validate_new/"); ?>
                            ...
                            <tr>
                                ...
                                <td class="tf-font tf-font-size">
                                    ...
                                    foreach($elements as $idx=>$element) {
                                        echo "<input type='checkbox' name='" . $element->name . "'>". $element->name . "</input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
