...
<head><title>TF Admin | Case study List</title></head>
<div class="nav tf-navbar">
    ...
    <button class="btn" onclick="window.location='<?php echo base_url();?>CaseStudy/addCaseStudy'">
        <span class="tf-database-add">&nbsp;</span>
        <a class="tf-font-orange" style="text-decoration: none;">New Case study</a>
    </button>
</div>

<div class="row" style="margin-left: 1em; ">
    <h1 class="tf-heading"> Case study List</h1>
</div>
...
<div class="table-responsive tf-font tf-font-size" style="margin-bottom: 3em;">
    <table id="case_study" class="table table-bordered table-striped" style="width: 60%;float: left;margin-left: 1em;">
        <thead>
        <tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#case_study').DataTable({
            ...
            "bInfo" : false,
            ajax: {
                url : "<?php echo site_url("caseStudy/getCaseStudies") ?>",
    ...
    function deleteCase(id){
        if (confirm("Are you sure?")){
            window.location.assign('<?php echo site_url("CaseStudy/delete/")?>'+id)
        }
