...
<?php 
    if($prev_media && $next_media){
        echo '<a href="'.base_url().'Media/view/'.$prev_media->id.'">&lt; previous</a>' 
         .' | '
         .'<a href="'.base_url().'Media/view/'.$next_media->id.'">next &gt;</a>';
    }
    else if($prev_media){
        echo '<a href="'.base_url().'Media/view/'.$prev_media->id.'">&lt; previous</a>' ;
    }
    else if($next_media){
        echo '<a href="'.base_url().'Media/view/'.$next_media->id.'">next &gt;</a>';
    }else{
        echo 'haha';
    }
