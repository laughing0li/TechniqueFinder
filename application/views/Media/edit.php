...
<?php 
if( $media_data->media_type == 'IMAGE'){
    echo form_open_multipart('Media/update_image/'.$media_data->id);
}else{
    echo form_open_multipart('Media/update_movie/'.$media_data->id);
}
?>
        ...
        <table style="text-align: left; width:90%;">
            <tr>
                ...
                <td class="tf-font tf-font-size">
                    <textarea name="caption" class="tf-input-big"><?php echo $media_data->caption; ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr style="<?php if($media_data->media_type !='MOVIE'){echo 'display:none';}?>" >
