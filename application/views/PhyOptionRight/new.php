...
<?php $this->load->view('layout/header.php');?>
    <head><title>TF Admin | Create Option</title></head>
    <div class="nav tf-navbar">
        ...
        <button class="btn" onclick="window.location='<?php echo base_url();?>PhyOptionRight/index'">
    ...
    <div class="row" style="margin-left: 1em; ">
        <h1 class="tf-heading"> Create Option</h1>
    </div>
...
<?php echo form_open("PhyOptionRight/create");?>
    ...
    <div>
        ...
        <button type="button" class="tf-button" onclick="window.location='<?php echo base_url();?>PhyOptionRight/index'">
