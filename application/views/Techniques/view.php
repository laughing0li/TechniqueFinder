...
<head><title>TF Admin | Show Technique</title></head>
...
<div class="row" style="margin-left: 1em; ">
    <?php
    if($prev_location==0){
        echo '<a href="'.base_url().'Techniques/view/'.$next_location.'">next &gt;</a>';
    }
    else if ($next_location == 0){
        echo '<a href="'.base_url().'Techniques/view/'.$prev_location.'">&lt;  prev </a>';
    }
    else {
        echo '<a href="'.base_url().'Techniques/view/'.$prev_location.'">&lt; previous </a> |
               <a href="'.base_url().'Techniques/view/'.$next_location.'">next &gt;</a>';
    }
