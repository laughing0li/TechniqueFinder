                    ...
                    if (mediaSelected != []) {
                        <?php foreach ($media_list as $media_item) { ?>
                            if (mediaSelected == <?php echo $media_item->id; ?>) {
                                $('#list_images').append("<img height=100 width=100  style='margin-left:0.3em;' src='<?php echo ('https://storage.googleapis.com/tf-4-agn.appspot.com/static/' . $media_item->location); ?>' alt='No Image Uploaded'/>");
                            }
                        <?php } ?>
                    }
                        ...
                        <?php foreach ($media_list as $media_item) { ?>
                            ...
                            outputSelected.forEach(function(element) {
                                if (element == <?php echo $media_item->id; ?>) {
                                    $('#output_images').append("<img height=100 width=100 style='margin-left:0.3em;' src='<?php echo ('https://storage.googleapis.com/tf-4-agn.appspot.com/static/' . $media_item->location); ?>' alt='No Image Uploaded'/>");
                                }
                            })
                        ...
                        <?php foreach ($media_list as $media_item) { ?>
                            instrumentSelected.forEach(function(element) {
                                if (element == <?php echo $media_item->id; ?>) {
                                    ...
                                    $('#instrument_images').append("<img height=100 width=100 style='margin-left:0.3em;' src='<?php echo ('https://storage.googleapis.com/tf-4-agn.appspot.com/static/' . $media_item->location); ?>' alt='No Image Uploaded'/>");
                                }
                            })
