...
<?php $this->load->view('layout/header.php');?>
    ...
    <div class="row" style="margin-left: 1em; ">
        <h1 class="tf-heading">Options associations for Physical sciences </h1>
    </div>
...
function onSelect(e){
    ...
    if(left_id && right_id){
        ...
        $.ajax({
            url: "<?php echo site_url('PhyOptionAssociation/onSelect');?>",
            type:'POST',
...
function onSave(){
    ...
    if(left_id && right_id){
        ...
        $.ajax({
            url: "<?php echo site_url('PhyOptionAssociation/onSave');?>",
            type:'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
