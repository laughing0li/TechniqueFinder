...
<?php $this->load->view('layout/header.php');?>
    <head><title>TF Admin | Create User</title></head>
    ...
    <div class="tf-box">
        <table style="text-align: left;">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input type="checkbox" name="super_administrator" <?php if(isset($_POST['super_administrator'])){echo "checked";}else{echo "unchecked";}?> />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input type="text" name="second_email" value="<?php if(isset($_POST['second_email'])){echo $_POST['second_email'];}?>"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input type="text" name="confirm_second_email" value="<?php if(isset($_POST['confirm_second_email'])){echo $_POST['confirm_second_email'];}?>"/>
                </td>
            </tr>
            <tr>
        ...
        $(document).ready(function() {
            $('#update').click(function (e) {
                ...
                $.ajax({
                    ...
                    type:'POST',
                    dataType: "json",
                    data: { username: username full_name: full_name, super_administrator:super_administrator, second_email: second_email, confirm_second_email:confirm_second_email},
