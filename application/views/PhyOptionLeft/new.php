...
<?php $this->load->view('layout/header.php');?>
    ...
    <div class="nav tf-navbar">
        ...
        <button class="btn" onclick="window.location='<?php echo base_url();?>PhyOptionLeft/index'">
...
<?php echo form_open("PhyOptionLeft/create");?>
    ...
    <div>
        ...
        <button type="button" class="tf-button" onclick="window.location='<?php echo base_url();?>PhyOptionLeft/index'">
