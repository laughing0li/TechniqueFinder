...
<?php $this->load->view('layout/header.php');?>
    <head><title>TF Admin | Edit Contact</title></head>
        ...
        <table style="text-align: left;">
            <tr>
                ...
                <td class="tf-font tf-font-size">
                    <input type="text" name="title" value="<?php if(isset($data['title'])){echo $data['title'];}?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="tf-font tf-font-size">
                    ...
                    <input type="text" name="position" value="<?php if(isset($data['contact_position'])){echo $data['contact_position'];}?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input type="text" name="telephone" value="<?php if(isset($data['telephone'])){echo $data['telephone'];}?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input name="technique_contact" type="checkbox"  <?php if(isset($technique_contact)){echo $technique_contact;}else{echo 'unchecked';}?>>
                </td>
            </tr>
