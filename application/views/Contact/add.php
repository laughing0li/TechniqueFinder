...
<?php $this->load->view('layout/header.php');?>
    <head><title>TF Admin | Create Contact</title></head>
    ...
    <div class="tf-box">
        <table style="text-align: left;">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input type="text" name="position" value="<?php if(isset($data['position'])){echo $data['position'];}?>" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;</td>
                <td class="tf-font tf-font-size">
                    <input name="technique_contact" type="checkbox"  <?php if(isset($data['technique_contact'])){echo 'checked';}else{echo 'unchecked';}?>>
                </td>
            </tr>
