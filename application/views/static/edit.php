...
<?php $this->load->view('layout/header.php');?>
    <head><title>TF Admin | Edit StaticContent</title></head>
        ...
        <table style="text-align: left;">
            ...
            <tr style="width:50em;">
                ...
                <td class="tf-font tf-font-size">
                    ...
                    <textarea name="static_text" class="ckeditor" id="ckeditor"><?php if (isset($static_data['text'])){echo $static_data['text'];};?></textarea>
                </td>
                </td>
            </tr>
