...
(64,'Other saws and cutters','Other saws and cutters','Other Saw and Cutter Models','isomet','','','','','','','','','','Low speed precision cutters 5-inch and 3-inch (isomet(R)) and wire saws can slice a mineral as small as few mm across','Low speed precision cutters 5-inch and 3-inch (isomet(R)) and wire saws can slice a mineral as small as few mm across','Keywords of other saws and cutters',1,'Alternate names of other saws and cutters',35),
(65,'Manual and Hydraulic rock splitter ','Manual and Hydraulic rock splitter ','Manual and Hydraulic rock splitter Models','Rocklabs','','','','','','','','','','Manual and Hydraulic rock splitter (Rocklabs) equipped with tungsten carbide blades and plates to minimise sample contamination, are used to split large samples into smaller, manageable pieces suitable for crushing.','Manual and Hydraulic rock splitter (Rocklabs) equipped with tungsten carbide blades and plates to minimise sample contamination, are used to split large samples into smaller, manageable pieces suitable for crushing.','Keywords of Manual and Hydraulic rock splitter ',1,'Alternate names of Manual and Hydraulic rock splitter ',35),
(66,'Jaw Crushers','Jaw Crushers','Jaw Crusher Models','Pulverisette','','','','','','','','','','Jaw crushers (Pulverisette) are ideal for pre-crushing of hard brittle materials. The sample is crushed under high pressure between one fixed and one movable crushing jaw. A variety of jaw crushers are available depending on expected rock size.','Jaw crushers (Pulverisette(R)) are ideal for pre-crushing of hard brittle materials. The sample is crushed under high pressure between one fixed and one movable crushing jaw. A variety of jaw crushers are available depending on expected rock size.','Keywords of Jaw Crushers',1,'Alternate names of Jaw Crushers',35),
(67,'Milling Machines ','Milling Machines ','Milling Machine Models','Milling Machine Manufacturer','','','','','','','','','','Milling machines are used as a function of rock type, quantity and expected level of trace elements to avoid cross contamination.','Milling machines are used as a function of rock type, quantity and expected level of trace elements to avoid cross contamination.','Keywords of Milling machines ',1,'Alternate names of  Milling machines ',35),
(68,'Logitech System','Logitech System','Logitech System','Logitech','','','','','','','','','','Logitech system: Logitech(TM) precision lapping and polishing system (x2), is a highly technical but versatile system, due to its high sample throughput is used for batch thinning and polishing thin sections and blocks.','Logitech system: Logitech(TM) precision lapping and polishing system (x2), is a highly technical but versatile system, due to its high sample throughput is used for batch thinning and polishing thin sections and blocks.','Keywords of Logitech System',1,'Alternate names of Logitech System',35),
(69,'Resin Vacuum Impregnation Chamber ','Resin Vacuum Impregnation Chamber','Resin Vacuum Impregnation Chamber','Resin Vacuum Impregnation Chamber Manufacturer','','','','','','','','','','Resin vacuum impregnation chamber is a resin components mixer to provide reproducible resin compositions. ','Resin vacuum impregnation chamber is a resin components mixer to provide reproducible resin compositions. ','Keywords of Resin Vacuum Impregnation Chamber',1,'Alternate names of Resin Vacuum Impregnation Chamber',35),
(70,'Automatic Mounting Press ','Automatic Mounting Press','Simplimet 3000','Buehler','','','','','','','','','','Automatic mounting press (Simplimet 3000 Buehler(TM)) casts samples at high pressure and temperature in epoxy or in other media (e.g., conductive, volatile free). ','Automatic mounting press (Simplimet 3000 Buehler (TM)) casts samples at high pressure and temperature in epoxy or in other media (e.g., conductive, volatile free). ','Keywords of Automatic Mounting Press',1,'Alternate names of Automatic Mounting Press',35),
(71,'Petrographic Thin Section Saws and Grinder Systems','Petrographic Thin Section Saws and Grinder Systems','Petrographic Thin Section Saws and Grinder System Models','Petrographic Thin Section Saws and Grinder System Manufacturers','','','','','','','','','','Petrographic thin section saws and grinder systems efficiently manage large sample loads. ','Petrographic thin section saws and grinder systems efficiently manage large sample loads. ','Keywords of Petrographic Thin Section Saws and Grinder Systems',1,'Alternate names of Petrographic Thin Section Saws and Grinder Systems',35),
(72,'Bench top automatic polishing/lapping units ','Bench top automatic polishing/lapping units ','Kent 3','Kemet','','','','','','','','','','Kent 3 Bench top automatic polishing/lapping units (Kemet(TM)) are used to obtain a fine polish down to 1/4 ?m. ','Kent 3 Bench top automatic polishing/lapping units (Kemet(TM)) are used to obtain a fine polish down to 1/4 ?m. ','Keywords of Bench top automatic polishing/lapping units ',1,'Alternate names of Bench top automatic polishing/lapping units ',35),
(73,'Bench top automatic polishing/lapping units ','Bench top automatic polishing/lapping units ','Tegramin 30','Struers','','','','','','','','','','The Tegramin 30(R) (Struers(TM)) is used as a stand-alone grinding and polishing equipment blocks of mineral separate (e.g., zircon, apatite, garnet and many other minerals). This machine offers a large degree of automatization, reproducibility and high performance. ','The Tegramin 30(R) (Struers(TM)) is used as a stand-alone grinding and polishing equipment blocks of mineral separate (e.g., zircon, apatite, garnet and many other minerals). This machine offers a large degree of automatization, reproducibility and high performance. ','Keywords of Bench top automatic polishing/lapping units ',1,'Alternate names of Bench top automatic polishing/lapping units ',35),
